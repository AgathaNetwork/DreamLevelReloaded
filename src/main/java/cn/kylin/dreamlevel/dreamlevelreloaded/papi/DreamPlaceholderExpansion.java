package cn.kylin.dreamlevel.dreamlevelreloaded.papi;
...
public class DreamPlaceholderExpansion extends PlaceholderExpansion {
    ...
    private DreamLevelReloaded plugin;
    ...
    public String getVersion() {
        return DreamLevelReloaded.version;
    }
    ...
    public DreamPlaceholderExpansion(DreamLevelReloaded plugin){
        this.plugin = plugin;
    }
    ...
    public String onPlaceholderRequest(Player player, String arg) {
        ...
        Level level = DreamLevelReloaded.levels.get(args[0]);
